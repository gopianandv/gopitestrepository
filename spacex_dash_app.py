...
def update_pie_chart(selected_site):
    ...
    values = [success_counts['success'], success_counts['failure']]

    fig = px.pie(data_frame=data, names=labels, values=values, title=title)
    return fig
...
def update_scatter_chart(selected_site, payload_range):
    ...
    filtered_data = data[(data['Payload Mass (kg)'] >= payload_min) & (data['Payload Mass (kg)'] <= payload_max)]
